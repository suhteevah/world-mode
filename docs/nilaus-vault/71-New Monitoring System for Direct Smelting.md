# New Monitoring System for Direct Smelting | #71
Video: https://www.youtube.com/watch?v=xPOL7tRzsmw
...
**Note:** This file contains only placeholder/non-Factorio text and lacks the actual episode transcript. Based on the title alone, this episode covers building a new monitoring system for direct smelting operations.

### Key Lessons
- Monitoring systems are essential when scaling direct smelting to track production vs consumption rates
- Visual indicators help identify bottlenecks before they cascade through the production chain

### Design Principles
- Build monitoring before scaling production so you can diagnose issues early
- Direct smelting (train-to-train) eliminates belt overhead but requires careful throughput tracking

### Ratios & Numbers
- No specific ratios available from this transcript (transcript missing)

### Mistakes to Avoid
- Do not scale production without monitoring in place first
- Avoid assuming production is sufficient based on visual inspection alone; use actual numbers